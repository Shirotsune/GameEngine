...
public class Main
{
    ...
    public static void main(String[] args)
    {
        ...
        /**
         * *******************************************************************
         * 1. x-axis resoluutio y-axis resoluutio alustaa ja ajaa
         * käyttöliittymän
         ********************************************************************
         */
        int resolutionX = 800;
        ...
        /**
         * *******************************************************************
         * 2. file_nameCV - CV:n sijainti file_nameMap - karttatiedosto lukee
         * muistiin tarpeelliset eri luokkien rakentamiseen tarvittavat tiedot.
         * Map ja CV olio luodaan näiden kahden perusteella. Huom! Map ja CV
         * olio halutaan vain konstruktoida kertaalleen.
         ********************************************************************
         */
        String file_nameCV = "";
        String file_nameMap = "";
        ...
        /**
         * ********************************************************************
         * 3. Alustetaan pelimaailma CV ja Map filejen perusteella. Maailma
         * generaattori on käytännössä vastuussa koko pelin rakenteesta. Pelin
         * päälooppi kutsutaan myös tämän luokan kautta.  
         *********************************************************************
         */
        ...
        /**
         * ********************************************************************
         * 4. (Cardinalin API dokumentaatio löytyy Cardinal tiedoston sisältä.)
         *********************************************************************
         */
